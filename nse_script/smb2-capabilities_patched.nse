...
local smb2 = require "smb2_patched"
...
action = function(host,port)
  ...
  for i, dialect in pairs(smb2_dialects) do
    ...
    if status then
      ...
      if dialect == 0x0311 and smbstate['is_support_compresson_lznt1'] then
        table.insert(capabilities, "SMBv3 Compression LZTN1 (Negotiation Context)")
      end
